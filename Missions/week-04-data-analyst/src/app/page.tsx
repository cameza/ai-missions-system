      ...
      <section className="mx-auto flex w-full max-w-5xl flex-col gap-12 text-center lg:text-left">
        <div className="space-y-6">
          ...
          <div className="flex flex-col items-center gap-4 sm:flex-row">
            <button className="w-full rounded-full bg-primary px-8 py-3 text-sm font-semibold uppercase tracking-widest text-primary-foreground transition hover:bg-primary/80 sm:w-auto">
